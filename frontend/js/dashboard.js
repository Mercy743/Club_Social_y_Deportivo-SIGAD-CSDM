...
function controlarAccesoPorRol() {
    ...
    const accesos = {
        admin:      ['usuarios', 'eventos', 'torneos', 'horarios', 'reservaciones', 'estadisticas', 'actividades'],
        instructor: ['torneos', 'horarios', 'reservaciones', 'actividades', 'eventos'],
        socio:      ['torneos', 'horarios', 'reservaciones', 'actividades', 'eventos']
    };
